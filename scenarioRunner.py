...
from dataExtract import hybridExtract
...
# Runs hybrid algorithm with levels of anonymization (1-5)
def runGraphHybrid(runs, lvl):
    path = 'dataList/tests/L'
    createAnonymizedGraphs(11, path, lvl)
    index = 0
    while index < runs:
        ...
        # hybridExtract.runGraph189(f1, lvl)
        # hybridExtract.runGraph2356(f1, f2, f1E, f2E, lvl)
        hybridExtract.runGraph4710(f1, f2, f3, f1E, f2E, f3E, lvl)
        index = index + 1       